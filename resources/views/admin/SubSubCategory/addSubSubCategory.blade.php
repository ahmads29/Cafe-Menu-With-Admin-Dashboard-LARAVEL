...
<head>
    ...
    <title>Add SubSubCategory</title>
    <!-- Bootstrap CSS -->
                            ...
                            <form action="{{ route('subsubcategories.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row pb-3  align-items-center">
                                    ...
                                    <div class="col-md-10">
                                        ...
                                        <input type="text" class="form-control" id="subsubcategorySelect" name="name" placeholder="Enter Sub sub category name" value="" required />
