    ...
    <section class="main">
        ...
        <div class="main--container">
            <div class="section--title">
                ...
                <button class="add--button white-color" id="addNewCategory"><a href="{{route('categories.create')}}" class="white-color"><i class="ri-add-circle-line"></i> Add New Category</a></button>
            </div>
                    ...
                    <table>
                        ...
                        <tbody id="categoriesTable">
                            @foreach ($categories as $category )
                                <tr>
                                    <td>
                                        <img src="{{ asset('storage/' . $category->icon) }}"  alt="Category Icon" width="75" height="75">
                                    </td>
                                    <td>{{ $category->name }}</td>
                                    <td>
            ...
            <div class="section--title">
                ...
                <button class="add--button" id="addNewCategory"><a href="{{route('subcategories.create')}}" class="white-color"><i class="ri-add-circle-line"></i> Add SubCategory</a></button>
            </div>
            <div class="manage--content">
                <!-- Categories Table -->
                <div class="table">
            ...
            <div class="section--title">
                <h3 class="title">Sub Sub Categories</h3>
                <button class="add--button" id="addNewCategory"><a href="{{route('subsubcategories.create')}}" class="white-color"><i class="ri-add-circle-line"></i> Add SubSubCtegory</a></button>
            </div>
            <div class="manage--content">
                <!-- Categories Table -->
                <div class="table">
                            ...
                            @foreach ($subsubcategories as $subsubcategory )
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('subsubcategories.destroy', $subsubcategory->id) }}" method="POST" style="display:inline;">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" style="width: 75px" class="btn btn-danger btn-sm">Delete</button>
                                        </form>
