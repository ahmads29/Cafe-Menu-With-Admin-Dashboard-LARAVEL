                            ...
                            <form action="{{ route('categories.update', $category->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row pb-3 pt-5 align-items-center">
                                    ...
                                    <div class="col-md-10">
                                        ...
                                        <input type="text" class="form-control" id="NameInput" name="name" placeholder="Enter category name" value="{{ $category->name }}" required />

                                    </div>
                                    <div class="col-md-10 pt-4 d-flex">
                                        <label for="ImageInput" class="form-label">Image:</label>
                                        <input class="pl-3" type="file"  class="form-control-file" id="ImageInput" name="icon" accept="image/*" />
                                    </div>
                                </div>
                                <span>Old image:</span>
                                <img src="{{ asset('storage/' . $category->icon) }}" class="pt-2" alt="Product Image" width="75" height="75">
