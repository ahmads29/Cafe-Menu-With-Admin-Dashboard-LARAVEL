    ...
    <section class="main">
        ...
        <div class="main--container">
            <div class="section--title">
                <h3 class="title">Edit SubCategory </h3>
                        ...
                        <div class="container">
                            ...
                            <form action="{{ route('subcategories.update',$subcategory->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row pb-3  align-items-center">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" class="form-control" id="subcategorySelect" name="name" placeholder="Enter category name" value={{$subcategory->name}} required />
                                    </div>
                                </div>
