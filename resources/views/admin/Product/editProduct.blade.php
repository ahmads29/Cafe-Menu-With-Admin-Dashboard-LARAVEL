                    ...
                    <div class="card card-nohover">
                        <div class="container">
                            ...
                            <form action="{{ route('products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <select id="categorySelect" name="category_id" class="form-control"  required aria-label="Product Category">
                                            ...
                                            @foreach ($categories as $category )
                                                <option value={{$category->id}}
                                                    @if ($category->id === $product->subsubcategory->subcategory->category_id) selected @endif>
                                                    {{$category->name}}
                                                </option>
                                            @endforeach
                                        </select>
                                        ...
                                        <select id="subCategorySelect" name="subcategory_id" class="form-control"  required aria-label="Product Category">
                                            ...
                                            @foreach ($subcategories as $subcategory )
                                                <option value={{$subcategory->id}}
                                                    @if ($subcategory->id === $product->subsubcategory->subcategory_id) selected @endif>
                                                    {{$subcategory->name}}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="row pb-3  align-items-center">
                                    <div class="col-md-2">
                                        <label for="subSubCategorySelect" class="form-label">Sub SubCategory:</label>
                                    </div>
                                    <div class="col-md-10">
                                        <select id="subSubCategorySelect" name="subsubcategory_id" class="form-control"  required aria-label="Product Category">
                                            <option value="" disabled    selected>Select a sub subcategory</option>
                                            @foreach ($subsubcategories as $subsubcategory )
                                                <option value={{$subsubcategory->id}}
                                                    @if ($subsubcategory->id === $product->subsubcategory->subcategory_id) selected @endif>
                                                    {{$subsubcategory->name}}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="row pt-4 pb-3 align-items-center">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" class="form-control" value="{{ $product->name }}" id="NameInput" name="name" placeholder="Enter product name" required />
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" class="form-control" id="PriceInput" name="price" value="{{$product->price}}"  placeholder="Enter product price" required />
                                    </div>
                                ...
                                <div class="row pt-4 pb-3 align-items-center">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" class="form-control" value="{{ $product->description }}" id="DescriptionInput" name="description" placeholder="Enter product description" />
                                    </div>
                                </div>
        ...
        $('#subCategorySelect').change(function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#subSubCategorySelect').append('<option value="">Select SubSubCategory</option>');
